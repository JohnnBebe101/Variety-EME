...
const ROUTE_MAP: Record<string, RouteInfo> = {
  ...
  '/msp': { page: 'msp' },
  '/msp/overview': { page: 'msp_overview' },
  '/msp/noc-services': { page: 'msp_noc' },
  '/msp/infrastructure': { page: 'msp_infrastructure' },
  '/msp/cybersecurity': { page: 'msp_cybersecurity' },
  '/msp/ict-connectivity': { page: 'msp_ict_connectivity' },
  '/msp/security-access': { page: 'msp_security_access' },
  '/msp/fire-safety': { page: 'msp_fire_safety' },
  '/msp/hvac': { page: 'msp_hvac' },
  '/msp/power-energy': { page: 'msp_power_energy' },
  '/academy/managed-services': { page: 'msp_overview' },
