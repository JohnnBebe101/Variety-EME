 ...
 */
const ssrRegistry = new Map<string, React.ComponentType>();
 ...
 */
export function registerSSRModule(key: string, Component: React.ComponentType) {
 ...
 */
export function ssrSafeLazy<T extends React.ComponentType>(
  factory: Factory<T>,
  registryKey: string
