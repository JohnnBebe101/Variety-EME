...
import ServicePages from './components/sections/services/index';
// const ExcellencePages = lazy(() => import('./components/sections/excellence/index')); // Archived
  ...
  const renderContent = () => {
    switch(currentPage) {
      case 'portfolio': return (
        <>
          <MetaTags title={t('nav.portfolio')} description="Our Project Portfolio" url="https://varietyeme.com/portfolio" image="https://varietyeme.com/assets/images/portfolio/hero-overview.webp" />
      ...
      case 'telecommunications_mobile_rollout': return (
        <>
          ...
          <ServicePages.TelecommunicationsMobileRollout onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('telecommunications', undefined, '/telecommunications')} heroImage="/assets/images/hero/hero-overview.webp" gradientFallback="from-black/5 to-transparent" currentPath="/telecommunications/mobile-rollout" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'telecommunications_fiber_optics': return (
        <>
          ...
          <ServicePages.TelecommunicationsFiberOptics onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('telecommunications', undefined, '/telecommunications')} heroImage="/assets/images/portfolio/optical-tansmission-network.webp" gradientFallback="from-black/5 to-transparent" currentPath="/telecommunications/fiber-optics" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'telecommunications_tower_civil_works': return (
        <>
          ...
          <ServicePages.TelecommunicationsTowerCivilWorks onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('telecommunications', undefined, '/telecommunications')} heroImage="/assets/images/portfolio/ethio-telecom-tower-rollout.webp" gradientFallback="from-black/5 to-transparent" currentPath="/telecommunications/tower-civil-works" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'telecommunications_operations_maintenance': return (
        <>
          ...
          <ServicePages.TelecommunicationsOperationsMaintenance onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('telecommunications', undefined, '/telecommunications')} heroImage="/assets/images/hero/hero-overview.webp" gradientFallback="from-black/5 to-transparent" currentPath="/telecommunications/operations-maintenance" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'telecommunications_warehouse_management': return (
        <>
          ...
          <ServicePages.TelecommunicationsWarehouseManagement
            ...
            onParentOverview={() => navigateTo('telecommunications', undefined, '/telecommunications')}
      ...
      case 'power_transmission_distribution': return (
        <>
          ...
          <ServicePages.PowerTransmissionDistribution onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('power', undefined, '/power')} heroImage="/assets/images/portfolio/400-kv-tower.webp" gradientFallback="from-black/5 to-transparent" currentPath="/power/transmission-distribution" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'power_minigrid_systems': return (
        <>
          ...
          <ServicePages.PowerMinigridSystems onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('power', undefined, '/power')} heroImage="/assets/images/hero/power.webp" gradientFallback="from-black/5 to-transparent" currentPath="/power/minigrid-systems" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'power_backup_power': return (
        <>
          ...
          <ServicePages.PowerBackupPower onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('power', undefined, '/power')} heroImage="/assets/images/hero/power.webp" gradientFallback="from-black/5 to-transparent" currentPath="/power/backup-power" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'power_building_electromechanical': return (
        <>
          ...
          <ServicePages.PowerBuildingElectromechanical onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('power', undefined, '/power')} heroImage="/assets/images/hero/hero-power.webp" gradientFallback="from-black/5 to-transparent" currentPath="/power/building-electromechanical" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'ict_datacenter_data_center_design': return (
        <>
          ...
          <ServicePages.IctDatacenterDataCenterDesign onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('ict_datacenter', undefined, '/ict-datacenter')} heroImage="/assets/images/portfolio/mofed-dc.webp" gradientFallback="from-black/5 to-transparent" currentPath="/ict-datacenter/data-center-design" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'ict_datacenter_enterprise_networking': return (
        <>
          ...
          <ServicePages.IctDatacenterEnterpriseNetworking onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('ict_datacenter', undefined, '/ict-datacenter')} heroImage="/assets/images/portfolio/entoto-tvet-1.webp" gradientFallback="from-black/5 to-transparent" currentPath="/ict-datacenter/enterprise-networking" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'ict_datacenter_system_development': return (
        <>
          ...
          <ServicePages.IctDatacenterSystemDevelopment onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('ict_datacenter', undefined, '/ict-datacenter')} heroImage="/assets/images/hero/hero-ict.webp" gradientFallback="from-black/5 to-transparent" currentPath="/ict-datacenter/system-development" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'ict_datacenter_cybersecurity_managed': return (
        <>
          ...
          <ServicePages.IctDatacenterCybersecurityManaged onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('ict_datacenter', undefined, '/ict-datacenter')} heroImage="/assets/images/hero/hero-ict.webp" gradientFallback="from-black/5 to-transparent" currentPath="/ict-datacenter/cybersecurity-managed" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'ict_datacenter_training_consultancy': return (
        <>
          ...
          <ServicePages.IctDatacenterTrainingConsultancy onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('ict_datacenter', undefined, '/ict-datacenter')} heroImage="/assets/images/hero/hero-ict.webp" gradientFallback="from-black/5 to-transparent" currentPath="/ict-datacenter/training-consultancy" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'academy_overview': return (
        <>
          ...
          <ServicePages.AcademyOverview onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('academy', undefined, '/academy')} heroImage="/assets/images/hero/hero-academy.webp" gradientFallback="from-black/5 to-transparent" currentPath="/academy/overview" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'academy_fiber_optics_certification': return (
        <>
          ...
          <ServicePages.AcademyFiberOpticsCertification onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('academy', undefined, '/academy')} heroImage="/assets/images/portfolio/Academy-practical-class.webp" gradientFallback="from-black/5 to-transparent" currentPath="/academy/fiber-optics-certification" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      case 'academy_telecom_automation_training': return (
        <>
          ...
          <ServicePages.AcademyTelecomAutomationTraining onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('academy', undefined, '/academy')} heroImage="/assets/images/hero/hero-academy.webp" gradientFallback="from-black/5 to-transparent" currentPath="/academy/telecom-automation-training" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
);
      case 'academy_institutional_partnerships': return (
        <>
          ...
          <ServicePages.AcademyInstitutionalPartnerships onBack={() => navigateTo('home')} onParentOverview={() => navigateTo('academy', undefined, '/academy')} heroImage="/assets/images/hero/hero-academy.webp" gradientFallback="from-black/5 to-transparent" currentPath="/academy/institutional-partnerships" onNavigate={(path) => navigateTo('home', undefined, path)} />
        </>
      );
      ...
      case 'msp_infrastructure': return (
        <>
          ...
          <MSPPage onNavigate={navigateTo} currentPath="/msp/infrastructure" />
        </>
      );
      case 'msp_cybersecurity': return (
        <>
          <MetaTags title="Managed Cybersecurity" description="Security monitoring and incident response" />
          <MSPPage onNavigate={navigateTo} currentPath="/msp/cybersecurity" />
        </>
      );
      case 'msp_ict_connectivity': return (
        <>
          ...
          <MSPPage onNavigate={navigateTo} currentPath="/msp/ict-connectivity" />
        </>
      );
      case 'msp_security_access': return (
        <>
          ...
          <MSPPage onNavigate={navigateTo} currentPath="/msp/security-access" />
        </>
      );
      case 'msp_fire_safety': return (
        <>
          ...
          <MSPPage onNavigate={navigateTo} currentPath="/msp/fire-safety" />
        </>
      );
      case 'msp_hvac': return (
        <>
          ...
          <MSPPage onNavigate={navigateTo} currentPath="/msp/hvac" />
        </>
      );
      case 'msp_power_energy': return (
        <>
          ...
          <MSPPage onNavigate={navigateTo} currentPath="/msp/power-energy" />
        </>
      );
 ...
 * Wraps AppInner with SiteProvider for global state management.
 * Routes are resolved from window.location.pathname via getRouteFromPath().
 * Page components are code-split using ssrSafeLazy() for SSR compatibility.
 *
 * @param initialPage - The page to render initially (used by prerender.ts)
 * @param i18n - Optional i18next instance (used by prerender.ts)
 */
const App: React.FC<AppProps> = ({ initialPage = 'home', i18n: i18nProp }) => {
  ...
  const appContent = (
    <SiteProvider initialPage={initialRoute.page} initialOpenContact={initialRoute.openContact ?? false}>
      <AppInner i18n={i18nProp} />
    </SiteProvider>
  );
