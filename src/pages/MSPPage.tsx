      ...
      <section className="py-16 px-12 lg:px-24 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <p className="text-brand-muted text-lg leading-relaxed">
            InfinEth Academy delivers practitioner-led training programs combined with ongoing managed services that keep your infrastructure performing at peak efficiency.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-12 lg:px-24 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <p className="texttext-brand-muted">Zero accidents mindset. Professionalism and customer satisfaction at every stage.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-12 lg:px-24 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="text-2xl font-bold text-brand-foreground mb-2">
              Ready to partner with InfinEth Academy?
            </h3>
