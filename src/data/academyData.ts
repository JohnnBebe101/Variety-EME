...
export const academyServices: { id: number; title: string; description: string; icon: LucideIcon; path: string; page: string }[] = [
  ...
  },
  {
  ...
  },
    {
      ...
      description: "Hands-on training in industrial automation for enterprise and government clients.",
      icon: Cpu,
...
export const academyHero = {
  ...
  pageSubtitle: "Industry-certified training programs in fiber optics and industrial automation that build the expertise your team needs.",
